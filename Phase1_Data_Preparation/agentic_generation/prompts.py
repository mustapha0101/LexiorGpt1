...
CHAT_PLANNER_SUPPLEMENT = (
    ...
    "de la conversation.\n"
    "Couverture : Cour suprême du Canada (y compris les pourvois québécois "
    "en droit civil), cours fédérales et cours d'autres provinces — les "
    "cours québécoises (QCCA, QCCS, QCCQ, TAT) ne sont PAS indexées et "
    "AUCUN outil ne les couvre (n'invente pas d'outil : "
    "search_quebec_jurisprudence n'existe pas). Pour de la jurisprudence "
    "québécoise : cherche les pourvois CSC via search_legal_documents sans "
    "filtre dataset; si rien de pertinent, passe à final_answer en "
    "orientant vers CanLII ou SOQUIJ.\n"
...
CHAT_WRITER_SUPPLEMENT = (
    ...
    "précédents.\n"
    "JURIDICTION : respecte la province indiquée par l'utilisateur. S'il "
