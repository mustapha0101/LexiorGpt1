...
# api_cost.py vit à plat dans Phase1_Data_Preparation (pipeline legacy) : on
# le réutilise plutôt que de dupliquer le comptage de jetons.
_PARENT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
if _PARENT not in sys.path:
    sys.path.insert(0, _PARENT)
from api_cost import CostTracker  # noqa: E402
