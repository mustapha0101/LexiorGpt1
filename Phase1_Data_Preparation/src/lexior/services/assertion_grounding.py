...
_SELECTION_SYSTEME = (
    ...
    "le même objet que la demande, et chaque condition factuelle matérielle "
    "exprimée par le texte est affirmée dans les faits fournis;\n"
    ...
    "survenait plus tard.\n\n"
    "N'infère jamais une condition absente et ne transforme pas un mot vague "
    "de la personne en qualification établie. Le fait de dire « problème », "
    "« accident » ou de demander un recours ne prouve pas les qualificatifs "
    "plus précis employés par le texte. Si une condition matérielle n'est pas "
    "affirmée, le statut est incertain, pas applicable.\n\n"
