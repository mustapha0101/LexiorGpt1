...
_SYSTEM_PROMPT = (
    ...
    "citant les dispositions pertinentes. La classification structurée "
    "du tour détermine si la juridiction ou le régime d'emploi change "
    "les sources : ne demande jamais le lieu ou l'activité de l'employeur "
    "si les indicateurs correspondants sont faux. Les autres faits d'application "
