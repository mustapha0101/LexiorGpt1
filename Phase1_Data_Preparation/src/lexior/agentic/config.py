...
_PHASE1_DIR = os.path.dirname(os.path.dirname(os.path.dirname(
    os.path.dirname(os.path.abspath(__file__)))))
DEFAULT_CONFIG_PATH = os.path.join(_PHASE1_DIR, "configs", "agentic_generation.yaml")
