...
exports.searchQuebecRegulations = searchQuebecRegulations;
exports.searchQuebecJurisprudence = searchQuebecJurisprudence;
exports.scrapeQuebecLegalInfo = scrapeQuebecLegalInfo;
 ...
 */
async function searchQuebecRegulations(query) {
    ...
    const validResults = result.results.filter((res) => {
 ...
 */
async function searchQuebecJurisprudence(query) {
 ...
 */
async function scrapeQuebecLegalInfo(type) {
