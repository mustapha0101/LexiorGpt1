...
const exa = new exa_js_1.default(exaKey);
    ...
    try {
        switch (name) {
            ...
            case "search_ccq_keywords": {
                ...
                const articles = (0, db_1.searchArticlesByKeyword)(keyword);
                if (articles.length === 0) {
            ...
            case "get_cpc_articles": {
                ...
                const articles = (0, db_1.getCpcArticles)(start_article, end_article);
                if (articles.length === 0) {
            ...
            case "search_cpc_keywords": {
                ...
                const articles = (0, db_1.searchCpcArticlesByKeyword)(keyword);
                if (articles.length === 0) {
            ...
            case "search_quebec_regulations": {
                ...
                const text = await (0, scraper_1.searchQuebecRegulations)(keyword);
            ...
            case "get_quebec_legal_info": {
                ...
                const text = await (0, scraper_1.scrapeQuebecLegalInfo)(type);
                return { content: [{ type: "text", text }] };
            }
            case "search_quebec_jurisprudence": {
                ...
                const text = await (0, scraper_1.searchQuebecJurisprudence)(query);
                return { content: [{ type: "text", text }] };
            }
            default:
    ...
    try {
        ...
        switch (name) {
            case "get_ccq_articles": {
                ...
                const articles = (0, db_1.getArticles)(start_article, end_article);
                resultText = articles.map((a) => `Article ${a.numero}\n${a.texte}`).join('\n\n');
                break;
            }
            case "search_ccq_keywords": {
                const { keyword } = args;
            ...
            case "search_quebec_regulations": {
                ...
                resultText = await (0, scraper_1.searchQuebecRegulations)(keyword);
                break;
            }
            case "get_quebec_regulation": {
                const { url } = args;
            ...
            case "get_quebec_legal_info": {
                ...
                resultText = await (0, scraper_1.scrapeQuebecLegalInfo)(type);
                break;
            }
            case "search_quebec_jurisprudence": {
                const { query } = args;
                ...
                resultText = await (0, scraper_1.searchQuebecJurisprudence)(query);
                break;
            }
            default:
...
Promise.all([(0, db_1.loadCcqDb)(), (0, db_1.loadCpcDb)()]).then(async () => {
    isDbLoaded = true;
